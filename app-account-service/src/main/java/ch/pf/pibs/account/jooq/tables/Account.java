 ...
 */
package ch.pf.pibs.account.jooq.tables;


import ch.pf.pibs.account.jooq.Keys;
import ch.pf.pibs.account.jooq.Public;
...
public class Account extends TableImpl<AccountRecord> {
    ...
    /**
     * The column <code>public.account.account_owner</code>.
     */
    public final TableField<AccountRecord, String> ACCOUNT_OWNER = createField(DSL.name("account_owner"), SQLDataType.VARCHAR.nullable(false), this, "");
